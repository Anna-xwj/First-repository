...
<form action="doDoubleOperation.jsp" method="post">
	...
	<hr>
	<h3 style="font-family:华文彩云;、font-size:5em" align="left">做题页面</h3>
	<div id="div1">
		  <div id="count">
 ...
 Random random = new Random();
  ...
  { 
    ...
    if(character1==1)//计算加法
    {
        ...
        operat="&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp第("+(i+1)+")题"+number1+"+"+number2;
        result[i]=num1+num2;
    }
    ...
    else if(character2==3)//乘号
    {
        if(character1==2)//若第一个运算符是减号，则再随机出来一个第二个数与第三个随机的数小于第二个数   num1>=num2*num3  num3<=num1/num2
        {
            ...
            String number3=String.valueOf(num3);
            operat="&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp第("+(i+1)+")题"+num1+"-"+num2+"*"+num3+"=";
